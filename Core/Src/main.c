...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, SX_RX_RST_Pin|LED_RX_Pin|LED_TX_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, USB_RST_Pin|SX_TX_CS_Pin|SX_TX_RST_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOG, LED_LED3_Pin|LED_LED2_Pin|LED_LED1_Pin|LED_USB_Pin
                          |LED_ACTIVE_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : SX_RX_RST_Pin LED_RX_Pin LED_TX_Pin */
  GPIO_InitStruct.Pin = SX_RX_RST_Pin|LED_RX_Pin|LED_TX_Pin;
  ...
  /*Configure GPIO pins : USB_RST_Pin SX_TX_CS_Pin SX_TX_RST_Pin */
  GPIO_InitStruct.Pin = USB_RST_Pin|SX_TX_CS_Pin|SX_TX_RST_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : LED_LED3_Pin LED_LED2_Pin LED_LED1_Pin LED_USB_Pin
                           LED_ACTIVE_Pin */
  GPIO_InitStruct.Pin = LED_LED3_Pin|LED_LED2_Pin|LED_LED1_Pin|LED_USB_Pin
                          |LED_ACTIVE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
